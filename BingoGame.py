# This is a very simple completely luck based bingo game. It has two bingo
# grids, one is player and the other is computer. Both these grids
# have numbers ranging from 1 to 35 arranged in them randomly. When 
# we press "space bar" key, a random number is drawn between
# 1 and 35. If that number is present in either or both of these grids
# it gets crossed. In this way whichever grid gets 5 rows or columns or
# diagonals lines completed wins the game.
